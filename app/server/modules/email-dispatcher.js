...
EM.server = require("emailjs/email").server.connect(
{
	...
	user 	    : process.env.EMAIL_USER || 'mail@gmail.com',
...
{
	var link =req.protocol + '://' + req.host +':'+ req.port +'/reset-password?e='+o.email+'&p='+o.pass;
	var html = "<html><body>";
...
EM.composeMailWithAttachment=function (path) {
